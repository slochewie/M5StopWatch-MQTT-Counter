...
public:
    BootLogo()
    {
        ...
        _label_logo->setText(is_wake ? "Waking up ..." : "NiteOwl.dev Counter");
        ...
        _label_msg->setText(is_wake ? "Reconnecting ..." : "Starting up ...");
...
public:
    ...
    bool imuGetInterruptStatus1(uint8_t& status);
